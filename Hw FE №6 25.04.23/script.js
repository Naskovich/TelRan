...
//3.Дан массив numbers. Вывести в консоль все числа из массива const numbers = [3, 5, 11, 2, 8, 1, 6];
...
// const numbers_squared = [3, 5, 11, 2, 8, 1, 6]
// for (let i = 0; i < numbers_squared.length; i++)
// console.log(numbers_squared[i] ** 2)
// const last_elem = numbers_squared[6] ** 2
